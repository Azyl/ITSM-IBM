SELECT 
  ...
  TO_CHAR(V_PROBLEM_ALL_DATA.LAST_COMPLETED_DATE, 'YYYY_MM') AS COMPLETED_DATE_YEAR_MONTH,
...
FROM   V_PROBLEM_ALL_DATA
    left  join
      V_QUAL_CONFIG_ITSM_SERVICE
    on
      V_PROBLEM_ALL_DATA."SERVICE" = V_QUAL_CONFIG_ITSM_SERVICE."ITSM_SERVICE"
WHERE
     V_PROBLEM_ALL_DATA.STATUS IN ('Draft','Under Review','Request For Authorization','Assigned','Under Investigation','Pending','Rejected')
  AND
